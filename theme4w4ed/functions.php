...
function theme4w4ed_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footerbar', 'theme4w4ed' ),
			'id'            => 'footer-1',
			'description'   => esc_html__( 'Add widgets here.', 'theme4w4ed' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
...
function theme4w4ed_scripts() {
	...
	wp_register_script('theme4w4ed-rest-api', get_template_directory_uri() . '/js/rest_api.js', array(), filemtime(get_template_directory(). "/js/rest_api.js"), true );
